            ...
            <div class="course-info">
                ...
                <div class="wrap-right">
                    ...
                    <div class="buy">
                        ...
                        <div class="add-cart" @click="add_to_cart">
                            <img src="/static/image/cart.svg" alt="">加入购物车
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="course-content">
                <div class="course-tab-list">
                    ...
                    <div class="tab-item" v-if="tabIndex==2">
                        ...
                        <div class="chapter-item" v-for="chap in chapter_list">
                            <p class="chapter-title"><img src="/static/image/12.png" alt="">{{ chap.name }}</p>
                            <ul class="lesson-list">
                                <li class="lesson-item" v-for="lesson in chap.coursesections">
                                    <p class="name"><span class="index">{{ chap.id }}-{{ lesson.id }}</span>
                                        {{ lesson.name }}
        ...
        add_to_cart() {
            ...
            if (token){
                this.$axios({
                    ...
                    // 购物车的数量显示在不同组件里传递参数,需要Vuex
                    this.$store.commit('add_to_cart',res.data.cart_length);
                }).catch(error=>{
